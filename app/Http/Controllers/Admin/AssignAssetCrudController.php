...
class AssignAssetCrudController extends CrudController
{
...
//        echo $barcode_no;
        ...
        $asset = Asset::with('category','brand')->where('barcode_no',$barcode_no)->first();
//        var_dump($asset);
    ...
    public function setUp()
    {
        ...
        */
        ...
        $this->crud->setEntityNameStrings('assign', 'Assigned Assets');
...
//        $this->crud->setFromDb();
        ...
        $this->crud->addField([
            ...
            'label' => 'Assign Assets',
            'type' => 'table_jq',
            'entity_singular' => 'asset', // used on the "Add X" button
            'columns' => [
                'barcode_no' => 'Barcode Number',
                'asset_name' => 'Asset Name',
                'category_name' => 'Category',
                'brand_name' => 'Brand'
            ],
            'max' => 50, // maximum rows allowed in the table
            'min' => 10 // minimum rows allowed in the table
        ]);
